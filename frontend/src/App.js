...
function App() {
  ...
  return (
    <div className="h-screen bg-gray-100 flex flex-col">
      <div className="flex-1 container mx-auto px-2 py-2 sm:px-4 sm:py-4 max-w-4xl flex flex-col overflow-hidden">
        <div className="flex-1 bg-white rounded-lg shadow-lg overflow-hidden flex flex-col">
          ...
          <div 
            ...
            className="bg-gray-50 flex-1 overflow-y-auto p-3 sm:p-4"
          >
            {messages.length === 0 ? (
